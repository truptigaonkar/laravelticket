            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header" style="background-color:#cccccc">
                    <div class="col-md-8">
                    <h3 class="box-title">Ticket List </h3> [tickets: <span class="badge">{{$tickets->total()}}</span> comments:<span class="badge">{{$comments->total()}}</span>]  
                    </div>
                    <div class="col-md-4">
                ...
                <div class="box-body table-responsive no-padding">
                    ...
                    <tbody>
                        ...
                        @endforeach
                    @else
                        <p>No tickets found in search</p>
                    @endif                                  
                </table>
